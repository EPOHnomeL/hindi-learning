...
named and fixed — not a vague aspiration.
...
- **Three adjacent maps own pieces of this; do not absorb them:**
  [welcome/01](../welcome/tickets/01-first-open-welcome-panel.md) (orientation once inside a
  course), [onboarding-video/01](../onboarding-video/tickets/01-scope-onboarding-and-marketing-video.md)
...
- Checkout mechanics — owned by the launch work and the marketplace.
