...
- [The Edition reader — `lib.loadEdition`](tickets/01-edition-reader.md) — the "translated row else source"
...
- [The Edition grant resolver — `grantsFor`](tickets/02-edition-grant-resolver.md) — the `viewer`/`entitled`/
...
- [Fold the Edition-selection resolvers — `resolveEdition`](tickets/03-fold-edition-selection-resolvers.md) —
