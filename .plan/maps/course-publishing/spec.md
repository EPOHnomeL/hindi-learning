...
the amendment above
**Source:** [Course-publishing map](map.md) — eight decision tickets
...
1. **`enrollments`** — a new fifth access grant (ticket 01 / [ADR 0023 draft](../../../docs/adr/0023-self-enroll-access-primitive.md)).
...
change surface. **Read [ADR 0023 draft](../../../docs/adr/0023-self-enroll-access-primitive.md)** for the
...
| # | Issue | Depends on |
|---|---|---|
| 09 | [Enrollments table & the `enrolled` grant](tickets/09-enrollments-and-enrolled-grant.md) | — |
| 10 | [Publish lifecycle (`topics.status`)](tickets/10-publish-lifecycle.md) | — |
| 11 | [Per-tenant `selling` flag](tickets/11-per-tenant-selling-flag.md) | — |
| 12 | [Tenant-domain link generation](tickets/12-tenant-domain-links.md) | — |
| 13 | [Self-enroll mutation](tickets/13-self-enroll-mutation.md) | 09, 10 |
| 14 | [Catalogue query](tickets/14-catalogue-query.md) | 09, 10, 11, 13 |
| 15 | [Catalogue surface ("Browse courses")](tickets/15-catalogue-surface.md) | 13, 14 |
| 16 | [Surface enrolled courses on the dashboard](tickets/16-enrolled-on-dashboard.md) | 09 |
