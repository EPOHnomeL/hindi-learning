...
# Research — App Router i18n approach for a no-URL-locale, runtime-addable app
...
A markdown options survey (linked as an asset) exists covering all four areas above and lands a
recommendation for ticket 04.

## Answer

Done 2026-07-19 (session 782007d9). Asset: **[research-app-router-i18n.md](research-app-router-i18n.md)** —
full options survey + a recommendation for ticket 04.
