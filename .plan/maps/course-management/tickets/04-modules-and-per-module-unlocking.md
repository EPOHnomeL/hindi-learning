...
<!-- was .plan/maps/course-management/tickets/04-modules-and-per-module-unlocking.md; that single-ticket map was consolidated into course-management -->
...
- **Reconcile with**
  [Scope learning-pyramid phases](../../pedagogy/tickets/01-scope-learning-pyramid-phases.md):
