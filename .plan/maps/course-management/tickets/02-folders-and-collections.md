...
3. **Delegating building to other people** — "hand over building capabilities" is the same
   question already open in [Self-serve course building](../../course-authoring/tickets/03-self-serve-course-building.md) (self-serve course building) — who else gets to create/own
...
<!-- was .plan/maps/course-management/tickets/02-folders-and-collections.md; that single-ticket map was consolidated into course-management -->
