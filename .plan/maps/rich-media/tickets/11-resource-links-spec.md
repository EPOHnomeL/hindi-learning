...
**Scopes from:** 10 — AI linking into course Resources
...
Claude Code can write durable Resource links into Lesson prose; the reader mints a fresh signed URL at click time (never a baked-in expiring one); the link survives immutable Lesson HTML and translation.

<!-- Migrated 2026-07-30 from GitHub issue #99 (filed 2026-07-24), when this repo retired
