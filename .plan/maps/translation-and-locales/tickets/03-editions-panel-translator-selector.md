...
<!-- Moved 2026-09-01 from translator-status-report/03 during the .plan consolidation (33 map dirs to 7 active maps).
     Renumbered because blocked_by is map-local; the old number stays that ticket's identity in the donor
     map's history. Both its blockers moved with it and kept their numbers: 01 and 02. -->
