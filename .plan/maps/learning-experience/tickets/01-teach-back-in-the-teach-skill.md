...
# Teach-back in the teach skill (close the pyramid's top)
...
`SKILL.md` (and the learning-record format, if it needs it) are updated so lessons routinely end in a teach-back loop and learners author reference entries — with zero new platform machinery.

<!-- Migrated 2026-07-30 from GitHub issue #84 (filed 2026-07-24), when this repo retired
     its remote tracker; see docs/agents/issue-tracker.md. -->

<!-- Moved 2026-09-01 from `pedagogy/03` during the .plan consolidation (33 map dirs to 7 active maps).
