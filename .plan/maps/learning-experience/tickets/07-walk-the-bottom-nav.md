...
> `/wayfinder .plan/maps/learning-experience/tickets/07-walk-the-bottom-nav.md`
...
<!-- Moved 2026-09-01 from `mobile-reader-todos/04` during the .plan consolidation (33 map dirs to 7 active maps).
