...
<!-- was .plan/maps/authoring/tickets/02-streamline-routine-effort.md; that single-ticket map was consolidated into course-authoring -->
...
<!-- Moved 2026-09-01 from `course-authoring/04` during the .plan consolidation (33 map dirs to 7 active maps).
