...
> `/wayfinder .plan/maps/authoring/tickets/08-editor-details-door.md`
...
<!-- Moved 2026-09-01 from `mobile-reader-todos/05` during the .plan consolidation (33 map dirs to 7 active maps).
