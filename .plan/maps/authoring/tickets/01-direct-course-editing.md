...
The direct-editing surface is specced — which fields and entities are hand-editable, how an in-place Edition correction avoids a full re-translate, and how ADR 0003 immutability is respected.

<!-- Migrated 2026-07-30 from GitHub issue #60 (filed 2026-07-24), when this repo retired
     its remote tracker; see docs/agents/issue-tracker.md. -->

<!-- Moved 2026-09-01 from `course-authoring/02` during the .plan consolidation (33 map dirs to 7 active maps).
