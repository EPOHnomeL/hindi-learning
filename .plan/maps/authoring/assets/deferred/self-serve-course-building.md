...
- Today's course creation ("seed-and-go") assumes a trusted author. Opening it to any user
  raises the same cost/abuse questions as `paid-marketplace/01` ([Authoring-cost funding & model-provider strategy](../../../distribution/tickets/01-authoring-cost-and-model-provider-strategy.md), authoring-cost funding
...
- Cost/metering for the generate step — ties into `paid-marketplace/01` ([Authoring-cost funding & model-provider strategy](../../../distribution/tickets/01-authoring-cost-and-model-provider-strategy.md)).
