...
# AI-assisted course editing (author edits a course via AI)

## Question

**Where it stands:** open (deferred post-demo) — the review/approve gate + edit-intents are not built (lessons auto-publish)
...
The edit-intent set, the draft/review gate, and the supersede-not-mutate rule that keeps Lessons immutable are specced, with implementation tickets opened.

<!-- Migrated 2026-07-30 from GitHub issue #59 (filed 2026-07-24), when this repo retired
