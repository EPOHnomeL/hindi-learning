...
> `/wayfinder .plan/maps/distribution/tickets/04-recurring-monthly-giving.md`
...
<!-- Moved 2026-09-01 from marketplace/06 during the .plan consolidation (33 map dirs to 7 active maps).
     Renumbered because blocked_by is map-local; the old number stays that ticket's identity in the donor
     map's history. blocked_by: [03] was dropped, not lost: marketplace/03 (the donation link and prompt) is RESOLVED and stayed on that map, so the edge cannot be expressed map-locally and no longer gates anything. -->
