...
[Delete button for courses](../../authoring/tickets/03-delete-button-for-courses.md) lands
...
<!-- Moved 2026-09-01 from topic-sharing/06 during the .plan consolidation (33 map dirs to 7 active maps).
     Renumbered because blocked_by is map-local; the old number stays that ticket's identity in the donor
     map's history. Its cascade half still waits on the course-delete mutation, now authoring/03. -->
