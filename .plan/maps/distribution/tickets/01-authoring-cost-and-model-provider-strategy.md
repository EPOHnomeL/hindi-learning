...
<!-- was .plan/maps/distribution/tickets/01-authoring-cost-and-model-provider-strategy.md; that single-ticket map was consolidated into marketplace -->
...
- Downstream consumers of whatever this decides:
  [Interactive AI chat substrate](../../learning-experience/tickets/02-interactive-ai-chat-substrate.md)
  ...
  [Scope course audio](../../authoring/assets/deferred/course-audio.md) (TTS per Edition).
...
<!-- Moved 2026-09-01 from marketplace/01 during the .plan consolidation (33 map dirs to 7 active maps).
