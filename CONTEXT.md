...
**Teacher Q&A** _(planned; [teacher-qa](.plan/maps/teacher-qa/spec.md), decided 2026-08-25, NOT built)_:
...
_Avoid_: the `qa` [[Feature flag]] (per [[Tenant]], gates the *asking* mutation and hides nothing), Questions (the rows themselves), chat, comments, "disable Q&A"
