...
**Source:** [Whitelabel map](issues/00-whitelabel-map.md) — six scoping tickets (01–06), all
...
(`<slug>.my-course.app`, already live over HTTPS per [ticket 05](issues/05-provision-tenant-subdomains.md)),
...
- Marketplace/payments and rich-media/video as *enforced* flags (name reserved, nothing to
  enforce yet — see [04](issues/04-scope-per-tenant-feature-flags.md)).
...
from [03](issues/03-scope-per-tenant-theming.md) and all five flags `true` (04's v1-migration
...
| # | Issue | Depends on |
|---|---|---|
| 07 | [Tenant schema & seed](issues/07-tenant-schema-and-seed.md) | — |
| 08 | [Scope-aware admin roles](issues/08-scope-aware-admin-roles.md) | 07 |
| 09 | [Design token contract cleanup](issues/09-design-token-contract-cleanup.md) | — |
| 10 | [Tenant resolution middleware](issues/10-tenant-resolution-middleware.md) | 07 |
| 11 | [SSR theme application](issues/11-ssr-theme-application.md) | 07, 09, 10 |
| 12 | [Brand asset upload](issues/12-brand-asset-upload.md) | 07 |
| 13 | [Lesson/reference tenant palette override](issues/13-lesson-tenant-palette-override.md) | 09, 11 |
| 14 | [Tenant-aware invite email](issues/14-tenant-aware-invite-email.md) | 07 |
| 15 | [Tenant-aware certificate](issues/15-tenant-aware-certificate.md) | 07, 11 |
| 16 | [Per-tenant landing pages](issues/16-per-tenant-landing-pages.md) | 11 |
| 17 | [Feature flag enforcement](issues/17-feature-flag-enforcement.md) | 07 |
| 18 | [Cross-host canonical redirect](issues/18-cross-host-canonical-redirect.md) | 07, 10 |
| 19 | [Dashboard: Tenants tab shell](issues/19-dashboard-tenants-tab-shell.md) | 08 |
| 20 | [Dashboard: theme editor](issues/20-dashboard-theme-editor.md) | 11, 12, 19 |
| 21 | [Dashboard: flag toggles](issues/21-dashboard-flag-toggles.md) | 17, 19 |
| 22 | [Dashboard: course/member assignment + tenant removal guard](issues/22-dashboard-assignment-and-removal.md) | 19 |
| 23 | [Legacy course tenant backfill](issues/23-legacy-course-tenant-backfill.md) | 07, 11, 13 |
