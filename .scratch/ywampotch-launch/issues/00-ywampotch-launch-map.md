...
<!-- INDEX, not a store. Each unit lives in its own ticket; this map gists and
     ...
     Full reasoning and the decisions behind all of it: ../PRD.md -->
...
Strictly sequential — see [PRD § Execution](../PRD.md). File overlap is high
...
[PRD § 1.2](../PRD.md), the ADR 0025 host-preservation check.
