# edition-deepening/02: The Edition grant resolver — `grantsFor`

**Status:** DONE (commit `7a2c5a3`)
...
## Resolution (grilled 2026-07-20, HITL)

**Status:** landed as tested code — commit `7a2c5a3`. `grantsFor` + `Grant` added,
